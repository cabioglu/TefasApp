...
const DetailAreaChartQuantity: React.FC<RechartsAreaChartProps> = ({
  dataHistory,
}) => {
  ...
  return (
    ...
    >
      <h2 className="text-xl font-semibold mb-2">{t("charts.quantity")}</h2>
...
export default DetailAreaChartQuantity;
